...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'c9', 'user' => 'ldlemir', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Product/ProductBundle/Entity'))), 'Product\\ProductBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('ProductProductBundle' => 'Product\\ProductBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Product/ProductBundle/Resources/views'), 'ProductProduct');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b7b0ae34c3bb64445121dade429270bc21bfbe20');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('589012c61f0650.28872897')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ProductProductBundle' => 'Product\\ProductBundle\\ProductProductBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'ProductProductBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Product/ProductBundle'),
                    'namespace' => 'Product\\ProductBundle',
                ),
            ...
            'database_port' => NULL,
            'database_name' => 'c9',
            'database_user' => 'ldlemir',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'b7b0ae34c3bb64445121dade429270bc21bfbe20',
            'locale' => 'en',
            ...
            'kernel.secret' => 'b7b0ae34c3bb64445121dade429270bc21bfbe20',
